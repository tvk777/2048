...
"use strict";
/* eslint no-console: ["error", { allow: ["warn", "log"] }] */ const { KEY_CODES, GAME_STATUS } = require("f78f6b97f0bc2872");
...
},{"789b00406e138236":"eIbh2","f78f6b97f0bc2872":"dCjhd"}],"eIbh2":[function(require,module,exports) {
/* eslint-disable max-len */ "use strict";
const { BOARD_SIZE, EMPTY_CELL, NEW_TILE_VALUES, PROBABILITY_TWO, WIN_TILE, GAME_STATUS } = require("681aacd7eab0a0fe");
   ...
   */ restart() {
    ...
    getEmptyCells() {
        ...
        for(let row = 0; row < this.size; row++){
            for(let cell = 0; cell < this.size; cell++)if (this.board[row][cell] === EMPTY_CELL) emptyCells.push({
                row,
                cell
            });
        }
    ...
    checkStatus() {
        if (this.board.some((row)=>row.includes(WIN_TILE))) this.status = GAME_STATUS.WIN;
        if (this.getEmptyCells().length === 0 && !this.canMerge()) this.status = GAME_STATUS.LOSE;
        return this.status;
    }
}
module.exports = Game;

},{"681aacd7eab0a0fe":"dCjhd"}],"dCjhd":[function(require,module,exports) {
"use strict";
const BOARD_SIZE = 4;
const EMPTY_CELL = 0;
